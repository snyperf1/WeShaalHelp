<script>
	import Statsprogress from '$lib/components/statistics/Statsprogress.svelte';
	export let value;
	export let capacity;
	export let color;
...
<div class="card mr-10 flex flex-col h-44 w-44 rounded-3xl bg-slate-700 text-white p-4">
	<div class="space-between flex max-h-12 min-w-full flex-row align-middle">
		<div
			class="p-1 mr-24 flex h-8 w-8 items-center justify-center bg-opacity-20 {color} rounded-md"
		>
			<svg
				class=""
				width="22"
