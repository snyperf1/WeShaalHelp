...
<nav class="bg-indigo-500 h-screen w-64 fixed text-white">
	<p class="mt-5 px-10">
		<span class="text-3xl ml-6">O </span><strong class="mb-5 text-3xl">Rebot</strong>
	</p>
	...
	<div class="ml-5 flex">
		<div class="py-5 flex">
			{#each $prevRoutes as element}
				<button class="mx-2 hover:bg-slate-600 text-slate-300 px-2 rounded">{element}</button>
