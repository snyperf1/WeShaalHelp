...
const _layout_reset = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"bg-indigo-500 h-screen w-64 fixed text-white"}"><p class="${"mt-5 px-10"}"><span class="${"text-3xl ml-2 mr-7"}">R</span><strong class="${"mb-5 text-3xl"}">Rebot</strong></p>
  <ul class="${"list-none flex flex-col mt-8"}"><a href="${"/student/"}">${validate_component(Navitem, "Navitem").$$render($$result, {}, {}, {
    label: () => {
    ...
    <a href="${"/student/tips"}">${validate_component(Navitem, "Navitem").$$render($$result, {}, {}, {
    label: () => {
    ...
    <a href="${"/student/message"}">${validate_component(Navitem, "Navitem").$$render($$result, {}, {}, {
    label: () => {
    ...
    <a href="${"/student/report/intro"}">${validate_component(Navitem, "Navitem").$$render($$result, {}, {}, {
    label: () => {
