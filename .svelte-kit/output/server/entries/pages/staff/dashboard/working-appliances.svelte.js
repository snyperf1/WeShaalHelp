...
const Working_appliances = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"pt-16 ml-72 text-white"}">${validate_component(Table, "Table").$$render($$result, { data, status: "working" }, {}, {})}</main>`;
});
export { Working_appliances as default };
